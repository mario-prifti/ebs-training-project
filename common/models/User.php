 ...
 * @property-read ActiveQuery $sentMessages
 * @property-read ActiveQuery $chatRooms
 * @property-read ActiveQuery $adminChatRooms
...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules(): array
    {
        return [
            ...
            ['role', 'default', 'value' => UserType::USER->value],
            ['role', 'in', 'range' => [UserType::USER->value, UserType::ADMIN->value]],
